...
import { PapOpeningPage } from 'components'
import { message } from 'antd';

const PapOpeningPageContainer = props => <PapOpeningPage {...props} />;
...
const mapDispatchToProps = dispatch => ({
  ...
  savePapr: (param,callBack) => dispatch(actions.request(actions.RQ.SAVE_PAPR,"/ajax/income/paper/issue",{
    params:param,
    method:'post',
    success:(res)=>{
...
export default connect(mapStateToProps, mapDispatchToProps)(PapOpeningPageContainer)
