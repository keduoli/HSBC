...
const FilButton = styled(Button)`
  ...
  height:30px;
`;
class InvoiceLinkFilterMake extends React.Component{
...
const InvoiceLinkFilter = Form.create()(InvoiceLinkFilterMake);
export default InvoiceLinkFilter
