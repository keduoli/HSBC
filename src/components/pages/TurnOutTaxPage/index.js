...
class TurnOutTaxPage extends React.Component{
  state={
    fpdm:"",
    fphm:'',
    kprq_area:'',
  ...
  render(){
    const { deductionReceive,transferCancel,resultList,getData,exportResult,resultLoad,getDetail,detailList,settingsList,deductionConfirm,confirmList } = this.props;
    return(
      <div>
        <NavTitle title="认证抵扣"
                  submeun='进项税转出'/>
